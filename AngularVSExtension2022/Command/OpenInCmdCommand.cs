...
namespace AngularVSExtension
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class OpenInCmdCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("61323670-1806-43d2-8482-b0a3ed4d1c8b");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenInCmdCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private OpenInCmdCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static OpenInCmdCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in OpenInCmdCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync((typeof(IMenuCommandService))) as OleMenuCommandService;
            Instance = new OpenInCmdCommand(package, commandService);
        }
